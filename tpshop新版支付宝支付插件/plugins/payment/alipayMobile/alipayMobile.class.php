...
class alipayMobile extends RelationModel {
	...
	function __construct(){
		...
		// //异步通知地址
		$this->alipay_config['notify_url'] =SITE_URL.U('Payment/notifyUrl',array('pay_code'=>'alipayMobile'));
		
		// //同步跳转
		$this->alipay_config['return_url'] = SITE_URL.U('Payment/returnUrl',array('pay_code'=>'alipayMobile'));
	...
	function response(){       //异步         
		...
		//file_put_contents('re.txt', $result);
