<?php 
 ...
 //session_start();
//define('APPID','101453029');   //$this->app_id 
//define('APPKEY','bd85ea158e715c8b3eaaba499a5b9caa');  //$this->app_key 
//define('CALLBACK','http://www.lingfengveeker.top/qqcallback.php');  //回调地址 
//define('SCOPE','get_user_info,list_album,add_album,upload_pic,add_topic,add_weibo');  //授权接口列表
use Think\Model\RelationModel;

class qq extends RelationModel {
 public $tableName = 'plugin'; // 插件表 

 private $app_id='';
 private $app_key='';
 private $call_back='';
 // public $app_id='101453029';
 // public $app_key='bd85ea158e715c8b3eaaba499a5b9caa';
 // public $call_back='http://www.lingfengveeker.top/qqcallback.php';
 private $scope='get_user_info,list_album,add_album,upload_pic,add_topic,add_weibo';
