...
require_once dirname(__FILE__).'/XMHttpClient.php';
require_once dirname(__FILE__).'/xiaomi.conf.php';
//echo $OAUTH2_URL;exit;
class XMOAuthClient extends XMHttpClient {

    protected $clientId;
    protected $clientSecret;
    protected $redirectUri;
    protected  $oauthUrl="https://account.xiaomi.com";
